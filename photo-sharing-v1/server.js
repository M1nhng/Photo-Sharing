...
// ---- Model Data (inline, mirroring src/modelData/models.js) ----
...
const comments = [
  ...
  },
  {
    ...
    comment: "If you see this text in boldface then HTML escaping isn't working properly.",
    user: jo,
    photo_id: photo1._id,
  },
  {
...
// GET /photosOfUser/:id - returns photos belonging to user
